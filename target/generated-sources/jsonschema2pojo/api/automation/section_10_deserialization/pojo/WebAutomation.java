...
public class WebAutomation {
    ...
    public String toString() {
        ...
        sb.append(WebAutomation.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WebAutomation) == false) {
            return false;
        }
        WebAutomation rhs = ((WebAutomation) other);
